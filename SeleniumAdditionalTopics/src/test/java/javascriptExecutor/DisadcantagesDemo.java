...
public class DisadcantagesDemo {
	...
	public static void main(String[] args) {
		...
		// man kann in disablede Felder schreiben oder disablede Buttons klicken
		// DAS SIND KEINE REALEN TESTFÄLLE <== normalerweise, aber mit Javascript ist es möglich
		JavascriptExecutor jse = (JavascriptExecutor)driver;
		jse.executeScript("arguments[0].value='eigentlich nicht erlaubt';", disabledTextfield);

	}

	public static String javaScriptGetTextOnPage(WebDriver driver) {
		
		JavascriptExecutor jse = (JavascriptExecutor)driver;
		return jse.executeScript("return document.documentElement.innerText").toString();			
	}

	public static void javaScriptScrollTillElement(WebDriver driver) {
	...
	public static void javaScriptScrollTillElement(WebDriver driver, WebElement element) {
		
		//document.getElementById('but2').scrollIntoView(true)
		JavascriptExecutor jse = (JavascriptExecutor)driver;
	...
	public static String javaScriptGetPageURL(WebDriver driver) {
	...
	public static String javaScriptGetPageTitle(WebDriver driver) {
